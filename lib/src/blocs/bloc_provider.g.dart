...
class $Provider extends Provider {
  static T of<T extends Bloc>() {
    switch (T) {
      ...
      case ViewCharacterBloc:
        {
          return BlocCache.getBlocInstance(
              "ViewCharacterBloc", () => ViewCharacterBloc.instance());
        }
      case InvitesBloc:
        {
          return BlocCache.getBlocInstance(
              "InvitesBloc", () => InvitesBloc.instance());
        }
      case SessionLogBloc:
        {
          return BlocCache.getBlocInstance(
              "SessionLogBloc", () => SessionLogBloc.instance());
        }
    }
    return null;
  }
  ...
  static void dispose<T extends Bloc>() {
    switch (T) {
      ...
      case ViewCharacterBloc:
        {
          BlocCache.dispose("ViewCharacterBloc");
          break;
        }
      case InvitesBloc:
        {
          BlocCache.dispose("InvitesBloc");
          break;
        }
      case SessionLogBloc:
        {
          BlocCache.dispose("SessionLogBloc");
          break;
        }
    }
  }
